...
from .data_augment import build_transform, RASampler
...
def build_imnet_dataset(
    ...
    print(f'is_train = {is_train}. Loading data from {root}')
...
class ImagenetDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        self.dataset_train, self.num_classes = build_imnet_dataset(
            is_train=True, 
        ...
        print(f'Deit Model setup on device {dist.get_rank()}, train_sampler instatiated, at time {time.time()}')
    ...
    def test_dataloader(self) -> DataLoader:
        """
        Uses the part of the train split of imagenet2012  that was not used for training via `num_imgs_per_test_class`
