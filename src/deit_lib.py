...
from timm.models import create_model as create_timm_models
from timm.models.layers import trunc_normal_


def create_vit_model(model_name, pretrained=False, **kwargs):
    model_dict = {
    ...
    return model_dict[model_name](pretrained, **kwargs)


def create_teacher_model(model_name, pretrained=False, **kwargs):
    return create_timm_models(model_name, pretrained=pretrained, **kwargs)
